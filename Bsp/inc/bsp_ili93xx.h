#ifndef __BSP_ILI93XX_H
#define __BSP_ILI93XX_H		
#include "sys.h"	 
#include "stdlib.h"
//////////////////////////////////////////////////////////////////////////////////	 
...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义---------------- 
#define	LCD_LED PEout(5) //LCD背光  PC8 	    
//LCD地址结构体
typedef struct
{
	vu16 LCD_REG;
...
void LCD_ShowChar(u16 x,u16 y,u16 fc, u16 bc, u8 num,u8 size,u8 mode);					//显示一个字符
...
void Gui_Drawbmp16WH(u16 x,u16 y,u16 width,u16 hight,const u8 *p);
...
#define SSD_HOR_BACK_PORCH		60		//水平前廊
#define SSD_HOR_FRONT_PORCH		60		//水平后廊

#define SSD_VER_PULSE_WIDTH		1		//垂直脉宽
#define SSD_VER_BACK_PORCH		60		//垂直前廊
#define SSD_VER_FRONT_PORCH		40		//垂直前廊
//如下几个参数，自动计算
